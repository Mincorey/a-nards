...
export default function PlayPage() {
  ...
  // Если пользователь ни разу не начинал партию (started === false) — уводим на
  // главную (закрытие без выбора = «передумал играть»). Иначе просто закрываем.
  function closeSetupModal() {
    if (!session.started) {
      // Пользователь передумал играть, не начав партию — возвращаем его на ту
      // страницу, откуда он открыл «Игра с ботом», а не на главную.
      nav(-1);
      return;
    }
    session.closeSetup();
